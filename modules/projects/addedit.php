			...
			<td width="50%" valign="top">
				<table cellspacing="0" cellpadding="2" border="0">
					...
					<tr>
						...
						<td width="100%" nowrap="nowrap" colspan="2">
							<?php echo arraySelect($companies_internal, 'project_company_internal', 'class="text" size="1"', $row->project_company_internal); ?>
						</td>
					</tr>
					<tr>
			...
			<td width="50%" valign="top">
				<table cellspacing="0" cellpadding="2" border="0" width="100%">
					...
					<tr>
						...
						<td nowrap="nowrap">
							<span id="test" title="test" style="background:#<?php echo (@$row->project_color_identifier) ? @$row->project_color_identifier : 'FFFFFF';?>;">
								<a href="#" onclick="javascript:newwin=window.open('?m=public&a=color_selector&dialog=1&callback=setColor', 'calwin', 'width=320, height=300, scrollbars=no');">
									<img src="./images/shim.gif" border="1" width="40" height="20" alt="" />
								</a>
							</span>
						</td>
					</tr>
